...
<div class="row border-bottom">
    <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
        ...
        <ul class="nav navbar-top-links navbar-right">
            <li>
                <span class="m-r-sm text-muted welcome-message">Chào mừng đến với Trầm Hương Tiên Phước</span>
            </li>
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-alerts">
                    <li>
                        <a href="#">
                            <div>
                                <i class="fa fa-envelope fa-fw"></i> Bạn có 5 tin nhắn mới
                    ...
                    <li>
                        <a href="#">
                            <div>
                                ...
                                <span class="pull-right text-muted small">4 giờ trước</span>
                            </div>
                        </a>
                    </li>
                    <li class="divider"></li>
