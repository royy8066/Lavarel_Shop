            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{ $user->email }}</td>
                        <td>
                            <a href="{{ route('backend.taikhoan.edit', $user->id) }}" class="btn btn-warning btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('backend.taikhoan.destroy', $user->id) }}" method="POST" style="display:inline-block;" onsubmit="return confirm('Xóa tài khoản này?')">
                                @csrf
                                @method('DELETE')
