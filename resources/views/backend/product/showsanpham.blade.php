...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="container">
            ...
            <a href="{{ route('backend.product.addsanpham') }}" class="btn btn-primary mb-3">Thêm sản phẩm</a>
                ...
                <tbody>
                    @foreach($product as $sp)
                        <tr>
                            ...
                            <td>{{ $sp->category->ten_danhmuc ?? 'Không rõ' }}</td>
                            <td>
                                @if($sp->img)
                                    <img src="{{ asset('storage/' . $sp->img) }}" width="80" alt="Hình ảnh">
                                @else
                                    Không có ảnh
                                @endif
                            </td>
                            ...
                            <td>
                                <a href="{{ route('backend.product.edit', $sp->id) }}" class="btn btn-warning btn-sm">
                                    <i class="fas fa-edit"></i>
                                </a>
                                <form action="{{ route('backend.product.delete', $sp->id) }}" method="POST" style="display:inline-block;">
                                    @csrf
                                    @method('DELETE')
