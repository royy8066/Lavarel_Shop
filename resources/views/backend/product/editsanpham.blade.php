...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="container">
            <h2 style="font-weight: bold; font-size: 30px; text-align:center;" class="text-center mb-4">Sửa Sản Phẩm</h2>
            ...
            <form action="{{ route('backend.product.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="ten_sanpham" value="{{ $product->ten_sanpham }}" class="form-control">
                </div>
                ...
                <div class="mb-3">
                    <label>Giá</label>
                    <input type="text" name="giasp" value="{{ $product->giasp }}" class="form-control">
                </div>

                <div class="mb-3">
                    <label>Hình ảnh</label><br>
                    @if($product->img)
                        <img src="{{ asset('storage/' . $product->img) }}" width="100" class="mb-2">
                    @endif
                ...
                <div class="mb-3">
                    ...
                    <select name="danhmuc_id" class="form-select">
                        @foreach($category as $cate)
                            <option value="{{ $cate->id }}" {{ $product->danhmuc_id == $cate->id ? 'selected' : '' }}>
                                {{ $cate->ten_danhmuc }}
                            </option>
                        @endforeach
                    </select>
