...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="container">
            <h2 style="text-align: center;  font-weight: bold; font-size: 30px;" class="text-center mb-4">Thêm sản phẩm mới</h2>
            ...
            <form action="{{ route('backend.product.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    <label style="padding-top: 7px" for="ten_sanpham" class="form-label">Tên sản phẩm</label>
                    <input type="text" name="ten_sanpham" id="ten_sanpham" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label style="padding-top: 7px" for="mota" class="form-label">Mô tả</label>
                    <textarea name="mota" id="mota" rows="4" class="form-control" required></textarea>
                </div>

                <div class="mb-3">
                    <label style="padding-top: 7px" for="giasp" class="form-label">Giá (VNĐ)</label>
                    <input type="number" name="giasp" id="giasp" class="form-control" required>
                </div>

                <div class="mb-3">
                    <label style="padding-top: 7px" for="img" class="form-label">Hình ảnh</label>
                    <input type="file" name="img" id="img" class="form-control" accept="image/*">
                </div>

                <div class="mb-3">
                    <label style="padding-top: 20px" for="danhmuc_id" class="form-label">Danh mục</label>
                ...
                <div class="mb-3">
                    <label style="padding-top: 20px" for="status" class="form-label">Trạng thái</label>
