...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="main-conten">
            <h3 style="text-align: center;  font-weight: bold; font-size: 30px;">Thêm Danh Mục Sản Phẩm</h3>

            <form id="danhMucForm" action="{{ route('backend.category.store') }}" method="POST">
                @csrf
                <div class="mb-3">
                    <label style="margin-top: 10px; font-size: 20px; color: black" for="ten_danhmuc" class="form-label">Tên Danh Mục</label>
                    <input style="border-radius: 5px;" type="text" class="form-control" placeholder="Nhập tên danh mục" name="ten_danhmuc" id="ten_danhmuc" required>
                </div>
                <button style="margin-top: 10px" type="submit" class="btn btn-primary">Thêm Danh Mục</button>
