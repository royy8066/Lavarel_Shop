...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <div class="container">
            <h2 style="font-weight: bold; font-size: 30px; text-align:center;" class="mb-4">Danh sách danh mục sản phẩm</h2>
            <a href="{{ route('backend.category.adddanhmuc') }}" class="btn btn-success mb-3">+ Thêm danh mục</a>
            ...
            <table class="table table-bordered table-hover text-center align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('backend.category.edit', $category->id) }}" class="btn btn-primary btn-sm">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form action="{{ route('backend.category.delete', $category->id) }}" method="POST" style="display:inline-block;">
                                @csrf
                                @method('DELETE')
