            ...
            <ul class="nav metismenu" id="side-menu">
                <li class="nav-header">
                    <div class="dropdown profile-element">
                        <span>
                            <img alt="image" src="/img/profile_small.jpg" class="rounded-circle" />
                        </span>
                        ...
                        <ul class="dropdown-menu animated fadeInRight m-t-xs">
                            <li><a href="{{ route('backend.profile') }}">Profile</a></li>
...
<div class="row">
    <div class="col-lg-3" style="margin-top:30px">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ number_format($tongDoanhThu) }} đ</h1>
                <div class="stat-percent font-bold text-success">+{{ $tangTruong ?? 0 }}% <i class="fa fa-bolt"></i></div>
    ...
    <div class="col-lg-3" style="margin-top:30px">
        <div class="ibox float-e-margins">
            ...
            <div class="ibox-content">
                <h1 class="no-margins">{{ $tongDonHang }}</h1>
                <div class="stat-percent font-bold text-info">+{{ $donXacNhan }} <i class="fa fa-level-up"></i></div>
    ...
    <div class="col-lg-3" style="margin-top:30px">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-warning pull-right">Chờ xác nhận</span>
                <h5>Đơn hàng mới</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{ $donCho }}</h1>
                <div class="stat-percent font-bold text-warning">Đang xử lý <i class="fa fa-clock-o"></i></div>
    ...
    <div class="col-lg-3" style="margin-top:30px">
        <div class="ibox float-e-margins">
            <div class="ibox-title">
                <span class="label label-primary pull-right">Toàn bộ</span>
                <h5>Tổng sản phẩm</h5>
            </div>
            <div class="ibox-content">
                <h1 class="no-margins">{{ $tongSanPham }}</h1>
                <div class="stat-percent font-bold text-primary"><i class="fa fa-cubes"></i></div>
                <small>Sản phẩm hiện có</small>
            </div>
        </div>
    </div>
</div>
