...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        ...
        <style>
            ...
            .btn-secondary:hover {
                background-color:rgb(8, 144, 248);
            }
        </style>
        ...
        <div class="container mt-4">
                        ...
                        <tr>
                            <td>
                                @if($detail->product && $detail->product->img)
                                    <img src="{{ asset('storage/' . $detail->product->img) }}" width="100" height="80" alt="Ảnh sản phẩm">
                                @else
                                    <span>Không có ảnh</span>
                                @endif
                            </td>
                            <td>{{ $detail->product->ten_sanpham ?? 'Đã xóa' }}</td>
            ...
            <a href="{{ route('backend.donhang.qldh') }}" class="btn btn-secondary">← Trở về</a>
        </div>
